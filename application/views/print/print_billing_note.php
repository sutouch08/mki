...
$header['left'] = array();
$company_full_name = getConfig('COMPANY_FULL_NAME');
$address1 = getConfig('COMPANY_ADDRESS1');
$address2 = getConfig('COMPANY_ADDRESS2');
$postcode = getConfig('COMPANY_POST_CODE');

$header['left']['A'] = array(
	'company_name' => "<span style='font-size:".($this->printer->font_size + 1)."px; font-weight:bolder; white-space:normal;'>".$company_full_name." (".getConfig('COMPANY_BRANCH_NAME').")"."</span>",
...
$footer = "
	<div style='width:190mm; height:30mm; margin:auto; position:absolute; bottom:5mm; left:5mm;'>
		<div style='width:70mm; height:30mm; text-align:center; float:left; padding-left:1mm; padding-right:1mm;'>
			<div style='font-size:{$this->font_size}px; width:70mm; height:5mm; text-align:center; float:left;'>ในนาม {$order->customer_name}</div>
			<div style='width:40mm; height:15mm; text-align:center; padding-left:10px; padding-right:10px; border-bottom:solid 1px #333; float:left;'>&nbsp;</div>
			<div style='width:25mm; height:15mm; text-align:center; padding-left:10px; margin-left:2mm; padding-right:10px; border-bottom:solid 1px #333; float:left;'>&nbsp;</div>
			<div style='font-size:{$this->font_size}px; width:40mm; height:5mm; text-align:center; padding-top:10px; float:left;'>ผู้รับวางบิล</div>
			<div style='font-size:{$this->font_size}px; width:25mm; height:5mm; text-align:center; margin-left:2mm; padding-top:10px; float:left;'>วันที่</div>
		</div>

		<div style='width:70mm; height:30mm; text-align:center; float:left; margin-left:50mm; padding-left:1mm; padding-right:1mm;'>
			<div style='font-size:{$this->font_size}px; width:70mm; height:5mm; text-align:center; float:left;'>ในนาม {$company_full_name}</div>
			<div style='width:40mm; height:15mm; text-align:center; padding-left:10px; padding-right:10px; border-bottom:solid 1px #333; float:left;'>&nbsp;</div>
			<div style='width:25mm; height:15mm; text-align:center; padding-left:10px; margin-left:2mm; padding-right:10px; border-bottom:solid 1px #333; float:left;'>&nbsp;</div>
			<div style='font-size:{$this->font_size}px; width:40mm; height:5mm; text-align:center; padding-top:10px; float:left;'>ผู้รับวางบิล</div>
			<div style='font-size:{$this->font_size}px; width:25mm; height:5mm; text-align:center; margin-left:2mm; padding-top:10px; float:left;'>วันที่</div>
...
while($total_page > 0 )
{
	...
	if($this->printer->current_page == $this->printer->total_page)
  {
	  ...
	  $sub_qty .= '</td>';
		$sub_qty .= '<td class="width-10 text-right" style="border:0;"></td>';
