...
<form id="searchForm" method="post" action="<?php echo current_url(); ?>">
	<div class="row">
		...
		<div class="col-lg-1 col-md-2 col-sm-2 col-xs-6 padding-5">
			...
			<select class="width-100 filter" name="isApprove">
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
		<table class="table table-striped table-hover border-1" style="min-width:850px;">
			<thead>
				<tr>
					...
					<th class="fix-width-100 middle">เลขที่งบ</th>
          ...
          <?php foreach($orders as $rs) : ?>
            <tr id="row-<?php echo $rs->code; ?>" style="<?php echo state_color($rs->state, $rs->status, $rs->is_expired); ?>">
              ...
              <td class="middle pointer" onclick="editOrder('<?php echo $rs->code; ?>')"><?php echo $rs->customer_name; ?></td>
							<td class="middle pointer" onclick="editOrder('<?php echo $rs->code; ?>')"><?php echo $rs->budget_code; ?></td>
