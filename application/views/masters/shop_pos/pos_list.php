...
<div class="row">
  ...
  <div class="col-sm-1 col-1-harf col-xs-6 padding-5">
    ...
    <input type="text" class="form-control input-sm text-center search-box" name="pos_code" value="<?php echo $pos_code; ?>" />
  </div>
		...
		<table class="table table-striped table-hover border-1">
			<thead>
				<tr>
					...
					<th class="width-10 middle text-center">Prefix</th>
					<th class="width-10 middle">POS NO</th>
					<th class="width-10 middle">POS CODE</th>
					<th class="width-20 middle">จุดขาย</th>
