...
$("#uploadFile").change(function(){
    ...
    $('#upload-modal').modal('hide');
		...
		if( file !== '')
		{
			load_in();
			$.ajax({
				url:BASE_URL + 'masters/customers/import_customers',
				type:"POST",
        cache:"false",
        data: fd,
        processData:false,
