        ...
        <div class="modal-content">
            ...
            <div class="row">
							<div class="col-sm-12 col-xs-12">
								<label>รหัส</label>
								<input type="text" class="form-control input-sm margin-bottom-10" id="a_code" maxlength="15" value="" onkeyup="validCode(this)" />
							</div>
							<div class="col-sm-12 col-xs-12">
								<label>ชื่อ</label>
								<input type="text" class="form-control input-sm" id="a_name" value=""  />
							</div>
            </div>
            </div>
