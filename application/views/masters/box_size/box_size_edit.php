...
<form class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-3 padding-5">
			<input type="text" name="name" id="name" class="form-control input-sm" value="<?php echo $name; ?>" required autofocus />
    </div>
  </div>
    ...
    <div class="col-xs-4 col-sm-1 padding-5">
			...
			<input type="number" name="box_width" id="box_width" class="form-control input-sm" value="<?php echo $box_width; ?>" />
    </div>
		<div class="col-xs-4 col-sm-1 padding-5">
			<label>ยาว(cm)</label>
			<input type="number" name="box_length" id="box_length" class="form-control input-sm" value="<?php echo $box_length; ?>" />
    </div>
		<div class="col-xs-4 col-sm-1 padding-5">
			<label>สูง(cm)</label>
			<input type="number" name="box_height" id="box_height" class="form-control input-sm" value="<?php echo $box_height; ?>" />
    </div>
  </div>
