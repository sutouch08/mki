...
<script id="template" type="text/x-handlebars-template">
  <table class="table table-bordered table-striped" style="min-width:1160px;">
      ...
      <th class="fix-width-120 middle text-center">ใบสั่งซื้อ</th>
			...
			<th class="fix-width-100 middle text-center">รหัส</th>
			<th class="fix-width-200 middle text-center">สินค้า</th>
